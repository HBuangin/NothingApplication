...
/**
 * Created by 你爹 on 2017/5/8 16:01.
 * Desc：
 */
...
public class SeparatedEditText extends androidx.appcompat.widget.AppCompatEditText {
    ...
    public SeparatedEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        borderColor = ta.getColor(R.styleable.SeparatedEditText_borderColor, ContextCompat.getColor(getContext(), R.color.c_666666));
        currentBorderColor = ta.getColor(R.styleable.SeparatedEditText_currentBorderColor, ContextCompat.getColor(getContext(), R.color.c_333333));
        blockColor = ta.getColor(R.styleable.SeparatedEditText_blockColor, ContextCompat.getColor(getContext(), R.color.white));
        textColor = ta.getColor(R.styleable.SeparatedEditText_textColor, ContextCompat.getColor(getContext(), R.color.c_333333));
...
//        }, 5000);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = (widthSpecSize - spacing * (maxLength - 1)) / maxLength;
    ...
    private void drawCursor(Canvas canvas) {
        if (!isCursorShowing && showCursor && contentText.length() < maxLength && hasFocus()) {
            ...
            int startX = spacing * (cursorPosition - 1) + boxWidth * (cursorPosition - 1) + boxWidth / 2;
    ...
    private void drawRect(Canvas canvas) {
        for (int i = 0; i < maxLength; i++) {
            ...
            int currentLength = contentText.length();
            if (i == currentLength) {
            ...
            boxRectF.set(spacing * (i) + boxWidth * i, 0,
                    spacing * (i) + boxWidth * i + boxWidth,
                    boxHeight);
    ...
    private void drawText(Canvas canvas, CharSequence charSequence) {
        for (int i = 0; i < charSequence.length(); i++) {
            int startX = spacing * (i) + boxWidth * i;
            int startY = 0;
            char c = charSequence.charAt(i);

            int baseX = (int) (startX + boxWidth / 2 - textPaint.measureText(String.valueOf(c)) / 2);
